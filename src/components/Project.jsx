    ...
    <motion.div
        ...
        <div className='container mx-auto px-6'>
            ...
            <div className='text-center mt-12'>
                <a href="projects" className='inline-flex items-center px-6 py-3 border border-purple rounded-lg font-medium hover:bg-purple/20        transition duration-300'>
