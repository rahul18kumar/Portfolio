    ...
    <div className='bg-dark-300 rounded-2xl overflow-hidden hover:-translate-y-2 transition duration-300 cursor-pointer'>
        ...
        <div className='p-6'>
            ...
            <div className='flex gap-2'>
                ...
                <a
                    href={code} target="blank"
                    className="flex-1 text-center px-4 py-2 border border-purple-600 font-medium rounded-lg hover:bg-purple-600/20 transition duration-300"
                >
                    Code
                    </a>
            </div>
